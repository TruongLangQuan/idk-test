...
const Question kQuestions[] = {
    {"Unit of force?", "J", "N", "W", 1},
    {"Ohm's law", "V=IR", "P=IV", "F=ma", 0},
    {"g ~ ?", "9.8", "3.14", "6.67", 0},
    {"Kinetic energy", "1/2mv2", "mgh", "p=mv", 0},
    {"Series R eq", "sum R", "1/sum", "R1R2", 0},
    {"Wave speed", "v=fl", "v=at", "v=Q/t", 0},
};
...
void drawMenu() {
  ...
  M5.Display.setTextColor(TFT_WHITE, TFT_BLACK);
  M5.Display.setCursor(2, 2);
  M5.Display.print("idk-exam-practice (physics)");
