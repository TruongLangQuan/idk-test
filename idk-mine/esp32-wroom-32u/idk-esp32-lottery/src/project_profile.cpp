...
{
  "project_name": "idk-esp32-lottery",
  "miner_name": "idk-nagger-4",
  "worker_name": "esp32-lottery",
  "default_coin": "BTC",
  "enable_ota": true,
  "pool_password": "x",
  "wallets": {
...
idk::ProjectProfile makeProjectProfile() {
  ...
  profile.projectName = "idk-esp32-lottery";
  profile.minerName = "idk-nagger-4";
  profile.wifiSsid = "Quan Le";
  profile.wifiPassword = "15032011";
  profile.defaultConfigJson = kDefaultConfigJson;
  profile.device = idk::DeviceKind::HEADLESS;
  profile.variant = idk::VariantKind::Lottery;
