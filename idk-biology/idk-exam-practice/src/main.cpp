...
const Question kQuestions[] = {
    {"DNA base pair", "A-T", "A-U", "G-U", 0},
    {"Protein site", "Ribosome", "Mitochondria", "Lysosome", 0},
    {"Genotype ratio 1", "1:2:1", "3:1", "9:3:3:1", 0},
    {"Photosynthesis", "Chloroplast", "Nucleus", "Ribosome", 0},
    {"Blood type O", "ii", "IAIA", "IBIB", 0},
};
...
void drawMenu() {
  ...
  M5.Display.setTextColor(TFT_WHITE, TFT_BLACK);
  M5.Display.setCursor(2, 2);
  M5.Display.print("idk-exam-practice (biology)");
