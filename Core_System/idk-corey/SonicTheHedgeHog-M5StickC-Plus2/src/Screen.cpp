...
void Screen::endDraw() {
        ...
        int _scrX = 120 - SCREEN_WIDTH / 2;
        int _scrY = 67 - SCREEN_HEIGHT / 2;
        StickCP2.Display.setAddrWindow(_scrX, _scrY, SCREEN_WIDTH, SCREEN_HEIGHT);
        for (int t = 0; t < SCREEN_HEIGHT / PART_BUFF_SIZE; t++) {
            ...
            StickCP2.Display.pushPixels(drawBuff, SCREEN_WIDTH * PART_BUFF_SIZE);
        }
