...
// Custom FAST TETRIS WiFi beacon names - 2025 Edition
const char Beacons[] PROGMEM = {"⚡FAST_TETRIS_LIGHTNING⚡\n"
                                "🎮TETRIS_SPEED_DEMON🎮\n"
                                "🔥BLAZING_BLOCKS_FIRE🔥\n"
                                "⚡TETRIS_TURBO_CHARGE⚡\n"
                                "🚀ROCKET_TETRIS_BOOST🚀\n"
                                "💫MATRIX_TETRIS_MODE💫\n"
                                "⚡LIGHTNING_BLOCKS_ZAP⚡\n"
                                "🎮CYBER_TETRIS_NET🎮\n"
                                "🔥FLAME_STACK_TOWER🔥\n"
                                "⚡ELECTRIC_TETRIS_GRID⚡\n"
                                "🚀HYPERSPEED_BLOCKS🚀\n"
                                "💎NEON_TETRIS_GEMS💎\n"
                                "⚡VOLTAGE_TETRIS_HIGH⚡\n"
                                "🌟STELLAR_BLOCK_DROP🌟\n"
                                ...
                                "🔥MOLTEN_TETRIS_CORE🔥\n"
                                "🎮PIXEL_PERFECT_DROP🎮\n"
                                "⚡CHAIN_LIGHTNING_STACK⚡\n"
                                "🌟SUPERNOVA_TETRIS_BOOM🌟\n"
                                "🚀JETPACK_BLOCK_FLIGHT🚀\n"
                                "💫DIMENSIONAL_TETRIS💫\n"
                                "⚡POWER_SURGE_BLOCKS⚡\n"
                                "🔥BLAZESTACK_INFERNO🔥\n"
                                "🎮GAMEBOY_TETRIS_LEGEND🎮\n"
                                "⚡ENERGY_DRINK_TETRIS⚡\n"
                                "🌟STARFIELD_BLOCKS🌟\n"
                                "🚀MACH_5_TETRIS_SPEED🚀\n"
                                "💎DIAMOND_BLOCK_RAIN💎\n"
                                "⚡ELECTRO_STACK_SHOCK⚡\n"
                                "🔥BURNOUT_TETRIS_DRIFT🔥\n"
                                "🎮COMBO_CHAIN_MASTER🎮\n"
                                "⚡THUNDERBOLT_BLOCKS⚡\n"
                                "🌟GALAXY_TETRIS_CRUISE🌟\n"
                                "🚀AFTERBURNER_BLOCKS🚀\n"
                                "💫HOLOGRAM_TETRIS_3D💫\n"
                                "⚡FLUX_CAPACITOR_STACK⚡\n"
                                "🔥DRAGON_BREATH_TETRIS🔥\n"
                                "🎮PERFECT_CLEAR_ZONE🎮\n"
                                "Mom Use This One\n"
                                "Abraham Linksys\n"
                                "Benjamin FrankLAN\n"
...
void beaconSpam() {
    ...
    M5.Lcd.drawString("⚡FAST Tetris WiFi🎮", 5, 20);
    M5.Lcd.drawString("Lightning Beacons...", 10, 40);
