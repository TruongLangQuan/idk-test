...
#define log_init nof_log_init
#define log_shutdown nof_log_shutdown
#define log_print nof_log_print
#define log_printf nof_log_printf
#define log_chain_logfunc nof_log_chain_logfunc
#define log_assert nof_log_assert
