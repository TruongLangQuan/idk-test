...
void actionExpr() {
  String expr = "";
  if (!keyboardInput(expr, "Expression", false, false, g_telex_mode, 120, true)) return;
  bool ok = false;
...
void actionStats() {
  String text = "";
  if (!keyboardInput(text, "List (space)", false, false, g_telex_mode, 160, true)) return;
...
void drawMenu() {
  ...
  M5.Display.print("idk-math-basic");
